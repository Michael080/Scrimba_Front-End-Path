...
const makeDaCake = ingredients => {
  const noChocMessage = "We can't make a chocolate cake because we are missing the ingredient chocolate";

  ingredients.includes('chocolate') ?
    console.log('We make da chocolate cake!!!') :
    console.log(noChocMessage);
}

makeDaCake(listIngredients);
